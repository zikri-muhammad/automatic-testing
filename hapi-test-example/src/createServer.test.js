...
describe('Hapi Server', () => {
    it('should respone 200 with payload value "Hello World" when GET /hello', async () => {
        // Arrang 
        ...
        // Assert
        const responeJson = JSON.parse(respone.payload);
        expect(respone.statusCode).toEqual(200);
        expect(responeJson.value).toEqual('Hello World')
    })
